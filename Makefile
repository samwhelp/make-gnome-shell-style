...
distro-any:
	REF_MASTER_DISTRO=any ./make-gnome-shell-style.sh
.PHONY: distro-any
...
distro-solus:
	REF_MASTER_DISTRO=solus ./make-gnome-shell-style.sh
.PHONY: distro-solus
...
distro-solus-style-vimix:
	REF_MASTER_DISTRO=solus REF_MASTER_STYLE=vimix ./make-gnome-shell-style.sh
